...
class Game:
    ...
    def __init__(self, m, n, k):
        ...
        self.turn = 'X'
        #Counter for the number of visited states each turn
    ...
    def MAX_VALUE(self):
        #check if the game is over, and return the utility if that's the case
        ...
        best_x = None
        best_y = None
        #initialize a count of visited states
        visited_states = 0
        ...
        #Add the number of visited states to the counter in the Game class attribute
